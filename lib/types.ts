...
export interface SetupBudgetItem {
  ...
  categoryId: string;
  category: string;
  itemSource: "existing_old_asset" | "old_renovation_cost" | "old_stock" | "new_item_to_buy" | "new_renovation_cost" | "replacement_or_repair" | "optional_future_item";
  required: boolean;
  ...
  assetOwnerPartnerId: string;
  paidBy: string;
  purchased: boolean;
  purchaseDate: string;
  condition: "New" | "Good" | "Used but usable" | "Needs repair" | "Not usable";
  stillUsableForNewConcept: boolean;
  countAsCapitalContribution: boolean;
  notes: string;
...
export interface Project {
  ...
  continuationType: "brand_new_project" | "existing_cafe_continuation" | "old_project_restarted" | "take_over_old_cafe" | "rebrand_existing_cafe";
  placeStatus: string;
